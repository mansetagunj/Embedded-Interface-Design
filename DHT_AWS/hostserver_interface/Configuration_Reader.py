...
class AWSConfigReader():
    ...
    def __init__(self, configfilename = None, sysargs = None):
        if configfilename is None and sysargs is None:
            print ("Config Reader input config params")
            sys.exit(0)
...
if __name__ == '__main__':
    AWSConfig = AWSConfigReader(None, sys.argv)
